# The script creates an Excel list of foreign personal accounts for each individual Branch Office of the Company
# with 5 parameters per record: First Name + Last Name + Job Position + Email address + Expiration_Date of the account
